...
🤖  Llama AI              - Intelligent chatbot & NLP
🧠  Natural Language      - Smart query processing
...
> 💡 **Tip:** Get your Firebase config from [Firebase Console](https://console.firebase.google.com/)
...
- 🤖 **AI-Powered** - Intelligent chatbot with Llama AI and NLP
- 💳 **Payment Ready** - Integrated secure payment gateway
...
**Made with 💪 and ☕ by the QuickCourt Team**
